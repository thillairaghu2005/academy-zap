...
const lightRules: editor.IStandaloneThemeData["rules"] = [
  ...
  { token: "string", foreground: "9F1D35" },
...
export const MONACO_THEMES: Record<IDETheme, ThemeDefinition> = {
  "zapsters-ide-dark": {
    ...
    colors: {
      ...
      "editorCursor.foreground": "#B4233C",
      "editor.selectionBackground": "#B4233C1F",
      "editor.inactiveSelectionBackground": "#B4233C14",
      "editor.lineHighlightBackground": "#B4233C09",
      ...
      "editorSuggestWidget.selectedBackground": "#B4233C17",
      "editorSuggestWidget.border": "#E5E7EB",
      "editorHoverWidget.background": "#FAFAFA",
      "editorHoverWidget.border": "#E5E7EB",
      "editorBracketHighlight.foreground1": "#B4233C",
      "editorBracketHighlight.foreground2": "#941B31",
      "editorBracketHighlight.foreground3": "#6B1224",
  ...
  "vs-light": { base: "vs", inherit: true, colors: lightColors("FFFFFF", "18181B", "FDF0F2"), rules: lightRules },
