            ...
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div>
                <h2 className="flex items-center gap-2 font-display text-lg font-bold tracking-tight">
                  <Shield className="size-5 text-purple-500" /> {board.name}
                </h2>
...
function GuildVsCard({
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-4">
      <p className="flex items-center gap-2 font-display text-sm font-semibold">
        <Swords className="size-4 text-purple-500" /> Guild vs guild
      </p>
  ...
  return (
    <div>
      <div className="flex items-center justify-between text-xs">
        <span className={cn("flex items-center gap-1.5 font-medium", ours && "text-purple-500")}>
