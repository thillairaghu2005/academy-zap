...
export function SkillCard({ name, description, icon: Icon, tone, href }: SkillCardProps) {
  return (
    <Link
      href={href}
      className="group grid h-full grid-cols-[auto_1fr_auto] items-start gap-4 rounded-2xl border border-border bg-card p-5 outline-none shadow-[0_8px_22px_rgb(17_24_39_/_4%)] transition-[border-color,transform,box-shadow] duration-200 hover:-translate-y-0.5 hover:border-primary/25 hover:shadow-[0_14px_30px_rgb(17_24_39_/_8%)] focus-visible:ring-2 focus-visible:ring-ring motion-reduce:transition-none"
    >
