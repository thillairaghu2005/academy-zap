...
export function Logo({ href = "/", className, iconOnly = false }: LogoProps) {
  return (
    ...
    >
      <span className="relative grid size-9 shrink-0 place-items-center overflow-hidden rounded-lg bg-gradient-to-br from-primary to-primary-hover shadow-md shadow-primary/20 transition-transform duration-300 group-hover:rotate-6 group-hover:scale-105">
