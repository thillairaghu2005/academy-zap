...
export function ProgressPulse({ userId }: { userId: string }) {
  ...
  if (query.isLoading) return <div className="mt-7 grid gap-4 lg:grid-cols-[1.2fr_0.8fr]"><Card className="h-56 bg-surface-1" /><Card className="h-56 bg-surface-1" /></div>;
